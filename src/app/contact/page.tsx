  ...
  const contactInfo = [
    {
      ...
      title: "Our Location",
      details: "109-17680 Rue Charles, Mirabel, QC J7J 0T6",
    },
    {
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start max-w-5xl mx-auto">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground">
                ...
                with an order, or want to explore partnership opportunities,
                we're here to help.
              </p>
              <p className="text-lg text-muted-foreground">
              ...
              <div className="pt-4">
                ...
                <div className="flex space-x-4">
                  <a
                    href="#"
                    className="p-2 rounded-full bg-purple-100 dark:bg-purple-900/20 text-purple-500 hover:bg-purple-200 dark:hover:bg-purple-900/40 transition-colors"
                  >
                    <svg
                      className="h-5 w-5"
                      fill="currentColor"
